@rem ************************************************************************
@rem * Copyright (C) 2015-2019 Dialog Semiconductor.
@rem * This computer program includes Confidential, Proprietary Information
@rem * of Dialog Semiconductor. All Rights Reserved.
@rem ************************************************************************
